...
if 'hello' in MyText:
    ...
    with mc as source:
        ...
        try:
            ...
            # be translated.
            print("Statement to be Translated :"+ get_sentence)
            ...
            speak = gTTS(text=text, lang=output_lang, slow= False) 
 
            # Using save() method to save the translated 
            # speech in capture_voice.mp3
            speak.save("translated_speech.mp3")     
        ...
        # provide better service to the user.
            ...
            print("not able to understand the input speech")
             
        except spr.RequestError as e:
            print("not able to provide required uutput".format(e))